...
CombatUnit::CombatUnit(const std::string& unitName, const char mapOverlayChar, const unsigned int initialMaxHealth,
...
std::optional<UnitAttack> CombatUnit::getUnitAttack(const unsigned int attackID) const {
